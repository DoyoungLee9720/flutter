...
void main() {
  // 1. Riverpod를 사용하기 위해서 ProviderScope로 감싼다.
          ...
          child: Column(
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () {
                  // 상태 변경 기능은 누가 들고 있을까?
                  // 데이터를 가지고 오는게 아니라 창고 자체를 들고 와서 그안에
                  // 머신을 동작 시켜야 한다.
...
/*
  ...
  - 데이터를 단순히 한 번 제공하는 역할, 상태가 변하지 않는 데이터를 관리할 때 사용하며
    즉 주로 정적인 데이터를 제공할때 사용한다.
    (단순 문자열, 정적 객체 등)
  StateNotifierProvier(02 예제) - 창고 관리자이다.
  - 상태를 관리(state) 변경할 수 ㅇ있는 창고 관리자 역할이다.
